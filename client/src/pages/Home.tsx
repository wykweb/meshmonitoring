...
const coreServices: ServiceCard[] = [
  ...
  {
    id: "malla-yyc-firehose",
    title: "Malla — YYCMesh",
    subtitle: "Observer Zapp Mobile — Calgary, Alberta",
    description:
      "Live data from the YYC Meshtastic Custom Network via the Zapp Mobile observer node and Malla. Real-time packet flow, signal quality, and node interactions across the YYC mesh.",
    url: "https://malla-yyc.meshmonitoring.com/",
    badge: "Firehose",
    badgeColor: "cyan",
    icon: <BotIcon className="w-6 h-6" />,
    tag: "malla-yyc.meshmonitoring.com",
    note: "Open Malla Firehose",
    noteUrl: "https://malla-yyc.meshmonitoring.com/",
    addedAt: "2026-04-22",
  ...
  {
    id: "mshca-firehose",
    title: "Malla CA — Live Packet Feed",
    subtitle: "Live Packet Feed — Canada & World Wide",
    description:
      "Live firehose feed from the Canadian Meshtastic network on Malla dashboard. Monitor real-time packet flow, node interactions, and network activity across Canada and beyond.",
    url: "https://mshca.meshmonitoring.com/packets",
    badge: "Firehose",
    badgeColor: "cyan",
    icon: <RadioIcon className="w-6 h-6" />,
    tag: "mshca.meshmonitoring.com",
    note: "Open CA Packet Feed",
    noteUrl: "https://mshca.meshmonitoring.com/packets",
    addedAt: "2026-05-07",
    verifiedAt: "2026-05-07",
  },
  {
    id: "yyc-metrics-firehose",
    title: "Grafana Dashboard — YYC Mesh Network",
    subtitle: "Zapp Mobile Observer — Calgary, Alberta, Canada",
    description:
      "Grafana dashboard for the YYC Meshtastic Metrics Exporter (Zapp Mobile Observer). Visualise live and historical node metrics, packet rates, signal strength, and network health for the Calgary mesh. Log in with username \"guest\" and password \"guest\" to view the dashboard.",
    url: "https://yycmme.meshmonitoring.com/login",
    badge: "Firehose",
    badgeColor: "amber",
    icon: <RadioIcon className="w-6 h-6" />,
    tag: "yycmme.meshmonitoring.com",
    note: "Login: guest / guest",
    noteUrl: "https://yycmme.meshmonitoring.com/login",
    addedAt: "2026-05-09",
  ...
  {
    id: "malla-yyc-chats",
    title: "YYC Mesh — Malla Chats",
    subtitle: "Malla Live Chat Stream — Calgary, Alberta",
    description:
      "Live chat stream from the YYC Mesh network on Malla dashboard. Browse real-time messages sent over the Calgary Meshtastic mesh, including channel traffic, direct messages, and community conversations as they happen on Malla.",
    url: "https://malla-yyc.meshmonitoring.com/chat",
    badge: "Chat",
    badgeColor: "cyan",
    icon: <NetworkIcon className="w-6 h-6" />,
    tag: "malla-yyc.meshmonitoring.com",
    note: "Open Malla Chat Stream",
    noteUrl: "https://malla-yyc.meshmonitoring.com/chat",
    addedAt: "2026-04-22",
    verifiedAt: "2026-04-22",
  },
  {
  ...
  {
    id: "mshca-chats",
    title: "Malla CA — Live Chat Stream",
    subtitle: "Malla Live Chat Stream — Canada & World Wide",
    description:
      "Live chat stream from the Canadian Meshtastic network on Malla dashboard. Browse real-time messages sent across the Canadian and worldwide Meshtastic mesh, including channel traffic, direct messages, and community conversations.",
    url: "https://mshca.meshmonitoring.com/chat",
    badge: "Chat",
    badgeColor: "cyan",
    icon: <NetworkIcon className="w-6 h-6" />,
    tag: "mshca.meshmonitoring.com",
    note: "Open Malla CA Chat Stream",
    noteUrl: "https://mshca.meshmonitoring.com/chat",
    addedAt: "2026-05-07",
    verifiedAt: "2026-05-07",
  },
  {
  ...
  {
    id: "corescope-yyc-firehose",
    title: "YYC MeshCore Network — CoreScope Firehose",
    subtitle: "CoreScope Packets — Calgary, Alberta",
    description:
      "Live packet firehose from the YYC MeshCore Network via CoreScope. Real-time view of all packet activity, node telemetry, and mesh traffic flowing through the Calgary MeshCore network.",
    url: "https://corescopeyyc.meshmonitoring.com/#/packets",
    badge: "Firehose",
    badgeColor: "rose",
    icon: <FirehoseIcon className="w-6 h-6" />,
    tag: "corescopeyyc.meshmonitoring.com",
    note: "YYC CoreScope",
    noteUrl: "https://corescopeyyc.meshmonitoring.com/#/live",
    addedAt: "2026-07-01",
    verifiedAt: "2026-07-01",
  },
  {
    id: "corescope-yyc-chat",
    title: "YYC MeshCore Network — CoreScope Chats",
    subtitle: "CoreScope Chat Channels — Calgary, Alberta",
    description:
      "Live chat channel stream from the YYC MeshCore Network via CoreScope. Browse real-time messages, channel traffic, and community conversations flowing through the Calgary MeshCore mesh.",
    url: "https://corescopeyyc.meshmonitoring.com/#/channels/%23chat",
    badge: "Chat",
    badgeColor: "rose",
    icon: <NetworkIcon className="w-6 h-6" />,
    tag: "corescopeyyc.meshmonitoring.com",
...
const communityServices: ServiceCard[] = [
  ...
  },
  {
    ...
    description:
      "Real-time MeshCore LoRa mesh network analyzer for the YYC Calgary network. Live view of node activity, RF links, packet flow, and mesh topology across the Calgary MeshCore community.",
    url: "https://corescopeyyc.meshmonitoring.com/#/live",
    badge: "Dashboard",
    badgeColor: "rose",
    icon: <NetworkIcon className="w-6 h-6" />,
    tag: "corescopeyyc.meshmonitoring.com",
...
const usaServices: ServiceCard[] = [
  ...
  {
    id: "florida-mesh-discord",
    title: "Florida Mesh",
    subtitle: "Discord Community",
    description:
      "Official Discord server for the Florida Mesh community — connect with mesh operators across the Sunshine State, share node updates, get setup help, and stay current with Florida mesh activity.",
    url: "https://discord.com/invite/floridamesh",
    badge: "Discord",
    badgeColor: "violet",
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
    ...
    tag: "discord.com/invite/floridamesh",
    addedAt: "2026-05-08",
    verifiedAt: "2026-05-08",
    note: "Network: Are You Meshing With Us? — areyoumeshingwith.us",
  },
  {
    id: "florida-mesh-chat",
    title: "Florida Mesh — Live Chat Stream",
    subtitle: "Florida — USA",
    description:
      "Live Meshtastic chat stream for the Florida mesh network, powered by Malla. Monitor real-time messages from mesh operators across the Sunshine State.",
    url: "https://malla.areyoumeshingwith.us/chat",
    badge: "Chat",
    badgeColor: "sky",
    icon: <RadioIcon className="w-6 h-6" />,
    tag: "malla.areyoumeshingwith.us",
    addedAt: "2026-05-08",
    verifiedAt: "2026-05-08",
    note: "Network: Are You Meshing With Us? — areyoumeshingwith.us",
  },
  {
    id: "florida-mesh-firehose",
    title: "Florida Mesh — Live Packet Feed",
    subtitle: "Florida — USA",
    description:
      "Live Meshtastic packet firehose for the Florida mesh network, powered by Malla. Watch real-time packet traffic from nodes across the Sunshine State.",
    url: "https://malla.areyoumeshingwith.us/packets",
    badge: "Firehose",
    badgeColor: "amber",
    icon: <RadioIcon className="w-6 h-6" />,
    tag: "malla.areyoumeshingwith.us",
  ...
  {
    id: "florida-mesh-map",
    title: "Florida Mesh — Node Map",
    subtitle: "Florida — USA",
    description:
      "Interactive live node map for the Florida Meshtastic mesh network. Explore active nodes, signal coverage, and network topology across the Sunshine State.",
    url: "https://map.areyoumeshingwith.us/",
    badge: "Map",
    badgeColor: "violet",
    icon: <MapPinIcon className="w-6 h-6" />,
    tag: "map.areyoumeshingwith.us",
    addedAt: "2026-05-08",
    verifiedAt: "2026-05-08",
    note: "Network: Are You Meshing With Us? — areyoumeshingwith.us",
  },
...
export default function Home() {
  ...
  const pillCounts: Record<string, number> = {
    ...
    Dashboard:    allCards.filter(c => c.badge === "Dashboard" || c.id === "potatomesh").length,
      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/6" style={{ background: "oklch(0.11 0.008 265 / 0.85)", backdropFilter: "blur(16px)" }}>
        <div className="container flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://t.me/+3XvTwby0GW1jYTU5"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/40 hover:text-[#229ED9] transition-colors duration-200"
              title="Mesh Networks on Telegram"
      ...
      <section className="relative min-h-[80vh] flex flex-col items-center justify-center pt-16 overflow-hidden">
        ...
        <div className="relative z-10 container text-center px-4 py-20">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 opacity-0 animate-fade-up animation-delay-400">
            ...
            <a
              href="https://meshcore.ca/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-orange-500/30 hover:border-orange-400/60 bg-orange-500/8 hover:bg-orange-500/15 text-orange-300 hover:text-orange-200 font-500 text-sm transition-all duration-200 hover:shadow-[0_0_18px_rgba(249,115,22,0.2)]"
              style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 500 }}
            >
              MeshCore Canada
              <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
